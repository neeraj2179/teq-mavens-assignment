...
export default function TimelinePoint({ lap, isActive, index }) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="text-center absolute top-9 whitespace-nowrap">
        <p
          className={`text-[12px] font-black tracking-[0.15em] transition-colors duration-300 uppercase ${
            isActive
              ? "text-text-primary"
        ...
        <p
          className={`text-[10px] mt-0.5 transition-colors duration-300 tracking-wide ${
